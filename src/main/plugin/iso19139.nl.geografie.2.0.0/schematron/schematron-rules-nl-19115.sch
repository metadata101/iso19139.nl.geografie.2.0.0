...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern id="Validatie tegen het Nederlands metadata profiel op ISO 19115 versie 2">
    ...
    <sch:rule id="Algemene metadata regels"  context="/gmd:MD_Metadata">
      ...
      <sch:assert id="Rol organisatie metadata (ISO nr. 379)" test="not($conformity_Spec_Title_Exsists) or ($conformity_Spec_Title_Exsists and $mdResponsibleParty_Role_INSPIRE)">Rol organisatie metadata (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#verantwoordelijke-organisatie-bron:-rol) ontbreekt of heeft een verkeerde waarde, deze dient voor INSPIRE contactpunt te zijn</sch:assert>
      ...
      <sch:assert id="Specificatie (ISO nr. 360)" test="not($thesaurus_INSPIRE_Exsists) or ($thesaurus_INSPIRE_Exsists and $conformity_Spec_Title_Exsists)">Specificatie (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#thesaurus) mist de verplichte waarde voor INSPIRE datasets. Als dit geen INSPIRE dataset is verwijder dan de thesaurus GEMET -INSPIRE themes, voor INSPIRE datasets in specificatie opnemen; VERORDENING (EU) Nr. 1089/2010 VAN DE COMMISSIE van 23 november 2010 ter uitvoering van Richtlijn 2007/2/EG van het Europees Parlement en de Raad betreffende de interoperabiliteit van verzamelingen ruimtelijke gegevens en van diensten met betrekking tot ruimtelijke gegevens</sch:assert>

      <!-- eind	-->

      <!-- 5.2.4 Unieke Identifier van de bron https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#unieke-identifier-van-de-bron -->
      <sch:assert id="Unieke Identifier van de bron (ISO nr. 207)" test="$identifierString or $identifierURI">Unieke Identifier van de bron (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#unieke-identifier-van-de-bron) ontbreekt</sch:assert>
      <sch:report id="Unieke Identifier van de bron (ISO nr. 207) info" test="$identifierString or $identifierURI">Unieke Identifier van de bron (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#unieke-identifier-van-de-bron): <sch:value-of select="$identifierString"/><sch:value-of select="$identifierURI"/>
      </sch:report>
    ...
    <sch:rule id="Codelijst media types" context="//gmd:CI_OnlineResource/gmd:protocol/gmx:Anchor[translate(text(), $uppercase, $lowercase) = 'gml' or translate(text(), $uppercase, $lowercase) = 'kml' or translate(text(), $uppercase, $lowercase) = 'geojson' or translate(text(), $uppercase, $lowercase) = 'gpkg' or translate(text(), $uppercase, $lowercase) = 'json' or translate(text(), $uppercase, $lowercase) = 'jsonld' or translate(text(), $uppercase, $lowercase) = 'rdf-xml' or translate(text(), $uppercase, $lowercase) = 'xml' or translate(text(), $uppercase, $lowercase) = 'zip' or translate(text(), $uppercase, $lowercase) = 'png' or translate(text(), $uppercase, $lowercase) = 'png' or translate(text(), $uppercase, $lowercase) = 'gif' or translate(text(), $uppercase, $lowercase) = 'jp2' or translate(text(), $uppercase, $lowercase) = 'tiff' or translate(text(), $uppercase, $lowercase) = 'csv' or translate(text(), $uppercase, $lowercase) = 'mapbox-vector-tile']">
    ...
    <sch:rule id="Codelijst INSPIRE OnLineDescriptionCode" context="//gmd:CI_OnlineResource/gmd:description/gmx:Anchor">
      <sch:let name="anchorUri" value="normalize-space(translate(@xlink:href, $uppercase, $lowercase))"/>
      <sch:let name="txt" value="normalize-space(translate(text(), $uppercase, $lowercase))"/>
      <sch:let name="combination" value="concat($anchorUri, '=', $txt)"/>
      <!-- NB: lowercase -->
    ...
    <sch:rule id="Referentiesysteem" context="//gmd:MD_Metadata/gmd:referenceSystemInfo/gmd:MD_ReferenceSystem">
      ...
      <sch:assert id="Code referentiesysteem (ISO nr. 207)" test="$referenceSystemInfo_CodeString or $referenceSystemInfo_CodeURI">Code referentiesysteem (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#codereferentiesysteem) waarde en/of URI ontbreekt</sch:assert>
