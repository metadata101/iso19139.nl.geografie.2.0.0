  ...
  <sch:ns prefix="geonet" uri="http://www.fao.org/geonetwork"/>
	...
	<sch:pattern id="Validatie_tegen_het_Nederlands_metadata_profiel_op_ISO_19115_versie_2_INSPIRE_metadata">
		...
		<!-- rules and assertions -->
			...
			<sch:report id="Beschrijving_hierarchisch_niveau__ISO_nr._7_info" test="$hierarchyLevelName">Tenminste 1 beschrijving hierarchisch niveau (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#hi%C3%ABrarchieniveaunaam) is gevonden
			</sch:report>
			...
			<sch:report id="Rol_organisatie_metadata__ISO_nr._379_info" test="$mdResponsibleParty_Role">Rol organisatie metadata (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#verantwoordelijke-organisatie-bron:-rol): <sch:value-of select="$mdResponsibleParty_Role"/>
			</sch:report>
		<!-- INSPIRE vereist pointOfContact https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#verantwoordelijke-organisatie-metadata:-rol -->
			<sch:assert id="Rol_organisatie_metadata__ISO_nr._379_INSPIRE" test="$mdResponsibleParty_Role_INSPIRE">Rol organisatie metadata (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#verantwoordelijke-organisatie-bron:-rol) dient voor INSPIRE contactpunt te zijn</sch:assert>
		<!-- eind INSPIRE in combi met specificatie INSPIRE -->
			...
			<sch:report id="Metadatastandaard_naam_ISO_nr._10_info" test="$metadataStandardName">Metadatastandaard naam (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#metadata-standaard-naam): <sch:value-of select="$metadataStandardName"/>
			</sch:report>
		...
		<!-- rules and assertions -->
			...
			<sch:assert id="Thesaurus__ISO_nr._360_" test="$thesaurus_INSPIRE_Exsists">Thesaurus (ISO nr. 360) voor INSPIRE ontbreekt</sch:assert>
	  ...
	  <!-- Thijs: om fouten in de validator te voorkomen als er metadata is aangeleverd met meerdere blokken dataQualityInfo (de NGR editor kan dit soort fouten veroorzaken), gebruik altijd alleen het eerste blok. Doe dit bij alle elementen gmd:dataQualityInfo -->
		...
		<!-- asssertions and report -->
			...
			<sch:report id="Protocol__ISO_nr._398_info" test="$transferOptions_Protocol or $transferOptions_Mediatype">Protocol (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#protocol): <sch:value-of select="gmd:CI_OnlineResource/gmd:protocol/*/text()"/>
			</sch:report>
			...
			<sch:report id="Naam_ISO_nr._400__info" test="$transferOptions_Name">Naam (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#naam) is : <sch:value-of select="$transferOptions_Name"/>
			</sch:report>
		...
		Voor INSPIRE altijd vereist, dus voorbehoud van de thesaurus weglaten. -->
			...
			<sch:assert id="INSPIRE_Specificatie_datum__ISO_nr._394" test="$conformity_Date">Specificatie datum (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#specificatiedatum) ontbreekt.</sch:assert>
			<sch:assert id="INSPIRE_Specificatiedatum_type_ISO_nr._395_" test="$conformity_Datetype">Specificatiedatum type (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#specificatiedatum-type) ontbreekt.</sch:assert>
		...
		<sch:rule id="Resolutie_en_toepassingschaal" context="//gmd:identificationInfo/gmd:MD_DataIdentification">
			...
			<sch:assert id="Toepassingsschaal__ISO_nr._57__en_Resolutie_ISO_nr._61_" test="not($denominator and  $distance) ">Toepassingsschaal (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#toepassingsschaal) of Resolutie (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#resolutie) invullen, niet beide</sch:assert>
       		</sch:rule>
		...
		<sch:rule id="Toepassingsschaal" context="//gmd:spatialResolution/gmd:MD_Resolution/gmd:equivalentScale/gmd:MD_RepresentativeFraction/gmd:denominator/gco:Integer">
			...
			<sch:assert id="Toepassingsschaal_ISO_nr._57_" test="not(string(number($denominator))='NaN')">Toepassingsschaal (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#toepassingsschaal) heeft een verkeerde waarde, toepassingsschaal is niet numeriek of is leeg.</sch:assert>

			<sch:report id="Toepassingsschaal_ISO_nr._57__info" test="$denominator">Toepassingsschaal (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#toepassingsschaal): <sch:value-of select="$denominator"/>
			</sch:report>
		</sch:rule>
		...
		<sch:rule id="Referentiesysteem" context="//gmd:MD_Metadata/gmd:referenceSystemInfo/gmd:MD_ReferenceSystem">
			...
			<sch:assert id="Code_referentiesysteem__ISO_nr._207__" test="$referenceSystemInfo_CodeString or $referenceSystemInfo_CodeURI">Code referentiesysteem (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#codereferentiesysteem) ontbreekt</sch:assert>
