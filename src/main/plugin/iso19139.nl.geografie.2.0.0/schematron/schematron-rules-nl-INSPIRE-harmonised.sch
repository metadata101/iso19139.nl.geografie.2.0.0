...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
	...
	-->
	<sch:pattern id="Validatie_tegen_het_Nederlands_metadata_profiel_op_ISO_19115_versie_2_INSPIRE_metadata">
		...
		<!-- rules and assertions -->
			...
			<sch:assert id="Metadata_ID__ISO_nr._2_" test="$fileIdentifier">Er is geen Metadata ID (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#metadata-unieke-identifier) opgegeven.</sch:assert>
			<sch:report id="Metadata_ID__ISO_nr._2__info" test="$fileIdentifier">Metadata ID: <sch:value-of select="$fileIdentifier"/>
			</sch:report>
		...
		<!-- INSPIRE vereist pointOfContact https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#verantwoordelijke-organisatie-metadata:-rol -->
			<sch:assert id="Rol_organisatie_metadata__ISO_nr._379" test="$mdResponsibleParty_Role_INSPIRE">Rol organisatie metadata (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#verantwoordelijke-organisatie-bron:-rol) dient voor INSPIRE contactpunt te zijn</sch:assert>
		<!-- eind INSPIRE in combi met specificatie INSPIRE -->
			...
			<sch:report id="Metadatastandaard_naam__ISO_nr._10_info" test="$metadataStandardName">Metadatastandaard naam (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#metadata-standaard-naam): <sch:value-of select="$metadataStandardName"/>
			</sch:report>
		...
		<!-- rules and assertions -->
			...
			<!-- Datum van de bron en Datum type van de bron, https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#datum-van-de-bron en https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#datum-type-van-de-bron-->
			<sch:assert id="Datum_van_de_bron_ISO_nr._394__en_Datumtype__ISO_nr.395_" test="$publicationDate or $creationDate or $revisionDate">Datum van de bron(https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#datum-van-de-bron) of Datumtype (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#datum-type-van-de-bron) ontbreken of heeft het verkeerde formaat (YYYY-MM-DD)</sch:assert>
			<sch:report id="Datum_van_de_bron_ISO_nr._394__en_Datumtype__ISO_nr.395__info" test="$publicationDate or $creationDate or $revisionDate">Tenminste 1 datum van de bron (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#datum-van-de-bron) is gevonden</sch:report>
			...
			<sch:report id="Samenvatting__ISO_nr._25__info" test="$abstract">Samenvatting (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#samenvatting): <sch:value-of select="$abstract"/>
			</sch:report>
			...
			<sch:report id="Rol_verantwoordelijke_organisatie_bron__ISO_nr._379_info" test="$responsibleParty_Role">Rol verantwoordelijke organisatie bron (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#verantwoordelijke-organisatie-bron:-rol) voldoet
			</sch:report>
			...
			<sch:report id="Trefwoorden__ISO_nr._53__info" test="$keyword">Tenminste 1 trefwoord (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#trefwoord) is gevonden (<sch:value-of select="$keyword"/>)
			</sch:report>

			<!-- Thesaurus alleen voor INSPIRE-->
			<sch:assert id="Thesaurus_ISO_nr._360_" test="$thesaurus_INSPIRE_Exsists">Thesaurus (ISO nr. 360) voor INSPIRE ontbreekt</sch:assert>
			<!-- eind Thesaurus alleen voor INSPIRE-->



			<!-- 5.2.4 Unieke Identifier van de bron https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#unieke-identifier-van-de-bron -->
			<sch:assert id="Unieke_Identifier_van_de_bron__ISO_nr._207_" test="$identifierURI">Unieke Identifier van de bron (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#unieke-identifier-van-de-bron) ontbreekt. Voor INSPIRE is een URI verplicht.</sch:assert>
			<sch:report id="Unieke_Identifier_van_de_bron__ISO_nr._207__info" test="$identifierURI">Unieke Identifier van de bron (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#unieke-identifier-van-de-bron): <sch:value-of select="$identifierURI"/>
			</sch:report>

			<!-- conditioneel: dus niet op testen als assertion -->
			<sch:report id="Dataset_taal__ISO_nr._39__info" test="$language">Dataset taal (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#taal-van-de-bron): <sch:value-of select="$language"/>
			</sch:report>
			...
			<sch:assert id="Minimum_y-coordinaat_ISO_nr._346_" test="(-90.00 &lt; $south) and ($south &lt; $north) or (-90.00 = $south) or ($south = $north)">Minimum y-coördinaat (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#omgrenzende-rechthoek) ontbreekt of heeft een verkeerde waarde</sch:assert>
			<sch:report id="Minimum_y-coordinaat_ISO_nr._346_info" test="(-90.00 &lt; $south) and ($south &lt; $north) or (-90.00 = $south) or ($south = $north)">Minimum y-coördinaat (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#omgrenzende-rechthoek): <sch:value-of select="$south"/>
			</sch:report>
			...
			<sch:report id="Overige_beperkingen__ISO_nr_72__2_info" test="$otherConstraint2">Overige beperkingen (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#overige-beperkingen) 2: <sch:value-of select="$otherConstraint2"/>
			</sch:report>
			...
			<sch:assert id="Ruimtelijk_schema_van_de_bron" test="$spatialRepresentationType">Ruimtelijk schema van de bron (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#ruimtelijk-schema-van-de-bron) is verplicht voor INSPIRE. </sch:assert>
			...
			<sch:assert id="Code_referentiesysteem__ISO_nr._207_assert" test="$referenceSystemInfo">Code referentiesysteem (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#codereferentiesysteem) ontbreekt</sch:assert>

		<!-- alle regels over elementen binnen distributionInfo -->
			<sch:let name="distributionFormatName" value="normalize-space(gmd:distributionInfo/gmd:MD_Distribution/gmd:distributionFormat/gmd:MD_Format/gmd:name[gco:CharacterString or gmx:Anchor]/*[name() != 'geonet:element'])"/>
			...
			<!-- INSPIRE Anchor -->
			<sch:let name="distributionFormatSpecification" value="normalize-space(gmd:distributionInfo/gmd:MD_Distribution/gmd:distributionFormat/gmd:MD_Format/gmd:specification[gco:CharacterString or gmx:Anchor]/*[name() != 'geonet:element'])"/>
		...
		<!-- Anchor, maar alleen voor INSPIRE geharmoniseerd verplicht  -->
			<sch:assert id="Naam_distributie_formaat__ISO_nr._285_" test="$distributionFormatName">Naam distributie formaat (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#naam-distributie-formaat) ontbreekt</sch:assert>
			<sch:report id="Naam_distributie_formaat__ISO_nr._285__info" test="$distributionFormatName">Naam distributie formaat (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#naam-distributie-formaat): <sch:value-of select="$distributionFormatName"/>
			</sch:report>
			<!-- Versie distributie formaat, https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#versie-distributie-formaat -->
			<sch:assert id="Versie_distributie_formaat__ISO_nr._286_" test="$distributionFormatVersion">Versie distributie formaat (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#versie-distributie-formaat) ontbreekt</sch:assert>
			<sch:report id="Versie_distributie_formaat__ISO_nr._286_info" test="$distributionFormatVersion">Versie distributie formaat (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#versie-distributie-formaat): <sch:value-of select="$distributionFormatVersion"/>
		</sch:report>
		<!-- Specificatie distributie formaat https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#specificatie-distributie-formaat -->
		<!-- Anchor, maar alleen voor INSPIRE geharmoniseerd verplicht  -->
			<sch:assert id="Specificatie_distributie_formaat__ISO_nr._288_" test="$distributionFormatSpecification">Specificatie distributie formaat (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#specificatie-distributie-formaat) ontbreekt</sch:assert>
			<sch:report id="Specificatie_distributie_formaat__ISO_nr._288__info" test="$distributionFormatSpecification">Specificatie distributie formaat (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#specificatie-distributie-formaat): <sch:value-of select="$distributionFormatSpecification"/>
			</sch:report>
	  ...
	  <!-- Thijs: om fouten in de validator te voorkomen als er metadata is aangeleverd met meerdere blokken dataQualityInfo (de NGR editor kan dit soort fouten veroorzaken), gebruik altijd alleen het eerste blok. Doe dit bij alle elementen gmd:dataQualityInfo -->
		...
		<!-- asssertions and report -->
			...
			<sch:report id="Protocol_ISO_nr._398__info" test="$transferOptions_Protocol or $transferOptions_Mediatype">Protocol (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#protocol): <sch:value-of select="gmd:CI_OnlineResource/gmd:protocol/*/text()"/>
			</sch:report>
		...
		<sch:rule id="Codelijst_media_types" context="//gmd:CI_OnlineResource/gmd:protocol/gmx:Anchor[text() = 'gml' or text() = 'kml' or text() = 'geojson' or text() = 'gpkg' or text() = 'json' or text() = 'jsonld' or text() = 'rdf-xml' or text() = 'xml' or text() = 'zip' or text() = 'png' or text() = 'png' or text() = 'gif' or text() = 'jp2' or text() = 'tiff' or text() = 'csv' or text() = 'mapbox-vector-tile']">
			<sch:let name="anchorUri" value="normalize-space(@xlink:href)"/>
			<sch:let name="txt" value="normalize-space(text())"/>
			<sch:let name="combination" value="concat($anchorUri, '=', $txt)"/>
		...
		Voor INSPIRE altijd vereist, dus voorbehoud van de thesaurus weglaten. -->
			<sch:assert id="INSPIRE_Specificatie__ISO_nr._360_" test="$conformity_SpecTitle">Specificatie (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#specificatie) mist de verplichte waarde voor INSPIRE datasets. Voor INSPIRE datasets in specificatie opnemen: VERORDENING (EU) Nr. 1089/2010 VAN DE COMMISSIE van 23 november 2010 ter uitvoering van Richtlijn 2007/2/EG van het Europees Parlement en de Raad betreffende de interoperabiliteit van verzamelingen ruimtelijke gegevens en van diensten met betrekking tot ruimtelijke gegevens</sch:assert>

			<sch:assert id="INSPIRE_Verklaring__ISO_nr._131_" test="$conformity_Explanation">Verklaring (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#verklaring) ontbreekt.</sch:assert>
			<sch:assert id="INSPIRE_Specificatiedatum__ISO_nr._394_" test="$conformity_Date">Specificatie datum (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#specificatiedatum) ontbreekt.</sch:assert>
			<sch:assert id="INSPIRE_Specificatiedatum_type__ISO_nr._395_" test="$conformity_Datetype">Specificatiedatum type (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#specificatiedatum-type) ontbreekt.</sch:assert>
			<sch:assert id="INSPIRE_Conformiteitindicatie_met_de_specificatie__ISO_nr._132_" test="$conformity_Pass">Conformiteitindicatie met de specificatie (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#conformiteit-indicatie-met-de-specificatie) ontbreekt.</sch:assert>
		...
		<sch:rule id="Resolutie_en_toepassingschaal" context="//gmd:identificationInfo/gmd:MD_DataIdentification">
			...
			<sch:assert id="Toepassingsschaal__ISO_nr._57__of_Resolutie_ISO_nr._61_" test="$denominator or $distance ">Toepassingsschaal (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#toepassingsschaal) of Resolutie (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#resolutie) ontbreekt, vul een van deze in</sch:assert>
		...
		<sch:rule id="Referentiesysteem" context="//gmd:MD_Metadata/gmd:referenceSystemInfo/gmd:MD_ReferenceSystem">
			...
			<sch:assert id="Code_referentiesysteem__ISO_nr._207_" test="$referenceSystemInfo_CodeString or $referenceSystemInfo_CodeURI">Code referentiesysteem (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#codereferentiesysteem) ontbreekt</sch:assert>
			<sch:report id="Code_referentiesysteem__ISO_nr._207__info" test="$referenceSystemInfo_CodeString or $referenceSystemInfo_CodeURI">Code referentiesysteem (https://docs.geostandaarden.nl/md/mdprofiel-iso19115/#codereferentiesysteem): <sch:value-of select="$referenceSystemInfo_CodeString"/> <sch:value-of select="$referenceSystemInfo_CodeURI"/>
			</sch:report>
