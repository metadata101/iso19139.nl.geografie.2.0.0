...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:gmd="http://www.isotc211.org/2005/gmd"
 ...
 <xsl:template name="get-iso19139.nl.geografie.2.0.0-title">
    <xsl:call-template name="get-iso19139-title"/>
  </xsl:template>

	<xsl:template name="get-iso19139.nl.geografie.2.0.0-is-service">
		<xsl:call-template name="get-iso19139-is-service"/>
	</xsl:template>

	<xsl:template name="get-iso19139.nl.geografie.2.0.0-extents-as-json">
		<xsl:call-template name="get-iso19139-extents-as-json"/>
	</xsl:template>

  <xsl:template name="get-iso19139.nl.geografie.2.0.0-online-source-config">
