...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:variable name="add-resource-id-loc">
    ...
    <msg id="a" xml:lang="dut">Dit record bevat geen dataset identificatie. 
      Voeg de volgende identificatie toe:
    </msg>
  </xsl:variable>
  ...
  <xsl:template name="analyze-add-resource-id">
    ...
    <xsl:variable name="hasResourceId"
                  select="$root//gmd:identificationInfo/*/gmd:citation/
            gmd:CI_Citation/gmd:identifier/*/gmd:code/gmx:Anchor/@xlink:href"/>
