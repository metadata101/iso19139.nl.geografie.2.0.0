...
1. Use [add-schema.sh](https://github.com/geonetwork/core-geonetwork/blob/4.4.x/add-schema.sh) for automatic deployment:
   ...
   ```
   ./add-schema.sh iso19139.nl.geografie.2.0.0 https://github.com/metadata101/iso19139.nl.geografie.2.0.0 4.4.x
   ```
...
- Copy the jar file schemas/iso19139.nl.geografie.2.0.0/target/schema-iso19139.nl.geografie.2.0.0-4.4.7-SNAPSHOT.jar to INSTALL_DIR/geonetwork/WEB-INF/lib.
...
Unzip [snippets.zip](https://github.com/metadata101/iso19139.nl.geografie.2.0.0/raw/4.4.x/snippets.zip) to a folder, use import (select type 'subtemplate') to import all the files into the catalogue.
