...
Unzip [snippets.zip](https://github.com/metadata101/iso19139.nl.geografie.2.0.0/raw/4.2.x/snippets.zip) to a folder, use import (select type 'subtemplate') to import all the files into the catalogue.
